...
$(document).ready(function(){
	...
	$("#preview_back").css('background-image', 'url(/images/mockup/product/'+$type+'/'+$color+'/'+$color+'_back.png) ') ;
	...
	$("#o_front").click(function(){
		$y_pos="front";
				$("#preview_front").css('background-image', 'url(/images/mockup/product/'+$type+'/'+$color+'/'+$color+'_'+$y_pos+'.png) ') ;
				$("#o_front").attr('src','/images/mockup/product/'+$type+'/'+$color+'/'+$color+'_front.png');
				$("#o_back").attr('src','/images/mockup/product/'+$type+'/'+$color+'/'+$color+'_back.png');
	...
	$("#o_back").click(function(){
		$y_pos="back";
				$("#preview_back").css('background-image', 'url(/images/mockup/product/'+$type+'/'+$color+'/'+$color+'_'+$y_pos+'.png) ') ;
				$("#o_front").attr('src','/images/mockup/product/'+$type+'/'+$color+'/'+$color+'_front.png');
				$("#o_back").attr('src','/images/mockup/product/'+$type+'/'+$color+'/'+$color+'_back.png');
